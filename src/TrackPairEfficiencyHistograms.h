...
public:
  ...
  THnSparseF* fhTrackPairsCloseToJet;        // Track pair histogram for particles close to a jet
  THnSparseF* fhGenParticlePairsCloseToJet;  // Generator level particle pair histogram for particles close to a jet
